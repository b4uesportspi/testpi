...
- Support for fast A2U payment flows alongside Pi Network payments
- Centralized transaction metadata handling for package purchases
- Email and admin notification pipeline updated to support A2U transaction status

### 🎮 Multi-Game Support
- **PUBG Mobile**: Purchase UC (Unknown Cash) packages
- **PUBG Mobile KR**: Korean version UC packages
- **Mobile Legends**: Buy Diamond packages
- **Clash of Clans**: Get Gold Pass subscriptions
- **Roblox**: Purchase Robux in-game currency
- **NEW STATE**: Gaming currency and battle pass packages
- **Free Fire**: Diamonds and in-game items

### 📱 Social Media Boosting Services
- **TikTok Coins**: Boost your TikTok presence with coin packages
- **YouTube Subscriptions**: Subscriber growth packages
- **Facebook**: Engagement and growth services
- **Instagram**: Follower and engagement packages
- **Netflix**: Subscription management and gifting
- **Canva**: Premium design tool subscriptions
...
- Robust transaction email pipeline for purchase confirmations, failures, and admin alerts
- Modernized email templates that show only package/payment details and hide connected account badges
